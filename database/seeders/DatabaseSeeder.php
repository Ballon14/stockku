...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $staffUsers = [];
        $staffNames = [
            ['name' => 'Andi Staff', 'email' => 'staff1@stokcku.com'],
            ['name' => 'Dewi Staff', 'email' => 'staff2@stokcku.com'],
            ['name' => 'Rudi Staff', 'email' => 'staff3@stokcku.com'],
        ];
