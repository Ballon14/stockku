        ...
        <div class="lg:col-span-1 bg-white rounded-2xl shadow-sm border border-slate-100 flex flex-col overflow-hidden">
            <div class="p-4 border-b border-slate-100">
                ...
                <div class="relative">
                    ...
                    <input wire:model.live.debounce.300ms="search" wire:keydown.enter="addBySearchEnter" type="text" placeholder="Nama produk / SKU / Kategori..." class="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-sm transition-all">
                </div>
            </div>
