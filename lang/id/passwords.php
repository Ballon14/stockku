...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut adalah default yang cocok dengan alasan yang
    | diberikan oleh password broker ketika kegagalan reset password terjadi,
    | seperti token yang tidak valid atau kata sandi baru yang tidak valid.
    |
    */
